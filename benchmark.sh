...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'data.json' -H 'Authorization: Bearer gyMaFGY0kEyzCVN1bq0L3gxqJyz5aweQ' http://417babe2-6810-4db4-8f93-42d18f27b1f3.westus2.azurecontainer.io/score
